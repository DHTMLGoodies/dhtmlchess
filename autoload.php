...
function autoload9f89eaa85f16150bc36133cb52d79108($class) {
    static $classes = null;
    if ($classes === null) {
        $classes = array(
            ...
            'alltests' => '/tests/php/AllTests.php',
            ...
            'installertest' => '/tests/php/installer/InstallerTest.php',
...
spl_autoload_register('autoload9f89eaa85f16150bc36133cb52d79108');
