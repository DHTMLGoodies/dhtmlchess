...
<head>
    ...
    $theme = isset($_GET["theme"]) ? preg_replace("/[^0-9a-z]/si", "", $_GET["theme"]) : "wood1";
    ...
    <div class="body">
        ...
        <script type="text/javascript">
            function selectTheme(){
                var val = $('#theme').val();
                if(val.length > 0){
                    location.href = 'demo-theme-2.php?theme=' + val;
                }
            }
        </script>
        <table>
            <tr><td>Select Theme:</td>
            <td><select id="theme" name="theme" onchange="selectTheme()">
                <option value="">Select theme</option>
                <option value="blue">Blue</option>
                <option value="brown">Brown</option>
                <option value="wood1">Wood 1</option>
                <option value="wood2">Wood 2</option>
                <option value="wood3">Wood 3</option>
                <option value="wood4">Wood 4</option>
                <option value="wood5">Wood 5</option>
                <option value="wood6">Wood 6</option>
            </select></td></tr>
        </table>
        <script type="text/javascript">
            $(document).ready(function() {
                $("#theme option[value='" + theme + "']").prop('selected', true);
        ...
        <div style="min-height:450px" class="dhtmlchess" data-dhtmlchess-pgn="WorldChamp1927" data-dhtmlchess-game="2"> </div>
        ...
        <ul>
            <li><strong>.chess-move-group</strong>: Styling of a pair of moves(example: 1 e4 e5). The default styling
                is display:inline-block to prevent line break in the middle</li>
