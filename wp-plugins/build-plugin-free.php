...
class Archiver
{
    ...
    private $destination = "zip/wordpresschess_free.zip";
    private $pwd;
    private $dir;
    ...
    private $files = array(
       /* "../js" => "dhtml_chess/api/",
        ...
        "../../wordpressfree/wp-content/plugins/wordpresschess_free/*" => "wordpresschess_free"
    );
    ...
    private function build()
    {
        ...
        echo "CWD " . getcwd()."<br>";
        if(file_exists("wordpresschess_free.zip"))unlink("wordpresschess_free.zip");

        exec("rm -rf wordpresschess_free");
        exec("mkdir wordpresschess_free");
       # exec("mkdir dhtml_chess/api");
        ...
        unlink("../../zip/wordpresschess_free.zip");

        chdir("..");


        $zipDestination = "../zip/wordpresschess_free.zip";

        HZip::zipDir("./wordpresschess_free", $zipDestination);

        echo "<br>Size: " . filesize($zipDestination);
        exec("cp -f ".$zipDestination." ../../../wp-testing/wordpresschess_free.zip");
