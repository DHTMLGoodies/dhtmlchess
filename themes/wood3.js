...
chess.THEME = {
    ...
    'chess.view.board.Board': {
        ...
        background:{
            borderRadius:'1%',
            horizontal:ludo.config.getDocumentRoot() + 'images/board-bg/wood-strip2-horizontal.png',
            vertical:ludo.config.getDocumentRoot() + 'images/board-bg/wood-strip2-vertical.png'
        },
        bgWhite: ludo.config.getDocumentRoot() + 'images/board/lightest-wood.png',
        bgBlack: ludo.config.getDocumentRoot() + 'images/board/wood-cherry.png',
        plugins: [
            {
