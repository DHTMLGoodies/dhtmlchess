...
class DhtmlChessViews
{
    ...
    public function eloHighscore($key, $countItems)
    {
        $elo = new DhtmlChessEloDb();
        $list = $elo->getList($key, $countItems);
        return $this->eloListAsHtml($list);
    }

    public function userEloHighscore($userId, $key, $countItems)
    {
        $elo = new DhtmlChessEloDb();
        $list = $elo->getUserList($userId, $key, $countItems);
        return $this->eloListAsHtml($list);
    }

    private function eloListAsHtml($list)
    {
