...
class DhtmlChessViews {
	...
	*/
	...
	public static function getTranslatedJSStrings($plugin_name){
		...
		$jsWords = array();
		$words   = array(
			"1 to enable sound effects . Default = 0 (no sounds)","A PGN String is required","Add comment","Add comment after","Add comment before","Annotate","Append Line","Archive Database","Archived Databases","Are you sure you want to discard this draft?","As new database","Black","Cancel","Castling","Clear","Click on all ","Click squares to solve the puzzles","Computer Eval","Could not import pgn string","Could not load game. Try again later","Country","DHTML Chess Forums","DHTML Chess Support","Database","Database Renamed","Database name","Databases can be archived from the editor by swiping right from the database list","Date","Delete","Delete Move","Delete a Database","Discard","Discard draft","Draft Saved","Draft discarded","E-mail","Edit metadata","En passant","Engine stopped","Event","Everything is up to date","Exit","FEN","For more help, visit","From elo","Full name","Game","Game Comment","Game Drafts","Game Drawn","Game Editor","Game Saved","Game Template","Game published","Game saved successfully","Games","Games in Database: ","Good job! You have solved this puzzle. Click OK to load next game.","Good move","Here are some of the key features of the editor","Hint","How to Use","If you want to permanently delete a database, you will first have to archive it, then delete it from the list of archived databases by swiping left on the database in the list","Import","Import PGN","Import games(PGN)","Import into ","Increment","Insert short tags into your posts using the format below. You can preview the tags from the<strong>Shorttags<\/strong> menu item","Into database","Into folder","Invalid Fen","Invalid command","Invalid game","Invalid grade","Invalid move","Invalid position","Last moves","Last updated","License","Load fen","Loading Stockfish JS","Loading drafts...","Loading game","Loading games...","Metadata","Move updated to","Moving","My profile","Name of new database","New Database","New Database created","New Game","New Game Database","New Position","New name","New rating","Next","Next Game","No Databases found","No Drafts Found","No archived databases","No database selected","No games","OK","Online Annotations - The Game Editor has a feature for annotating the games","Opponent rating:","Optional CSS styling","Optional attribute for positioning the board when width is less than 100%. This option is also only applied to large screens","Optional property for Tactic Puzzles. If set, random games will be pulled from the database. The default behaviour is to show the games in sequence. For opening training, this could be a useful setting.","Optional property which lets you override default theme","Optional width which is only set on large screens","Overwrite","PGN Databases","PGN archived","PGN deleted","PGN files can be imported from the <strong>Import PGN<\/strong> menu item. The PGN will be saved on the server as a game database which you can render games from using the [chess] shorttag","PGN restored","PGN:","Password","Paste fen into the text box below","Paste your PGN here","Pgn File","Pgn files","Player Black","Player White","Ply","Poor move","Position setup","Previous","Properties","Publish","Publish Game","Publish game in","Questionable move","Rated","Register","Rematch","Remember me","Rename Database","Repeat password","Restore","Result","Round","Same as above, but override default template","Samples","Save","Save Draft","Save Eval","Save all changes","Save game","Search","Select PGN","Selected","Set this property to show tactic puzzles using the games defined in the db property.","Settings","Shortcodes","Show board with this","Show game with id 100, using game template 5","Show games from pgn database 1 using view template 1","Side to move","Sign in","Sign out","Signed in as","Site","Solution","Speculative move","Standings","Start","StockFish.JS Engine","Stockfish Ready","StockfishJS loaded. Loading Opening Book","Styles separated by semicolon, eg. fill:#f00;stroke:blue","Support","Swipe right to restore, Swipe left to permanently delete","Tactic Puzzles","The Game Editor","There are {0} pinned pieces","These are the available properties","This are the available tags","Time","To elo","True to enable Sofia Rules when generating leaderboards for tournaments (3 points for 1, 1 point for draw)","Undo","Update","Username","Variation","Very good move","Very poor move","Well done - Puzzle complete","Which template to choose when rendering the board. There are different templates to choose from for game and database views. Example: to show a game using the fifth game template, set tpl to 5. The different templates can be previews from the shorttags menu item","White","WordPressChess is a plugin based on DHTML Chess from dhtmlchess.com","Wrong move - please try again","You Won","You archive a database using swipe right gestures from the list of databases in the game editor","You have unsaved changed. ","You have unsaved game data. Do you want to discard these?","You lost","You play black","You play white","You play {color} vs StockFishJS","Your color:","Your country","Your rating","commandWelcome","command_","ex: 1400","fen position","loading StockfishJS","min","sec","signedInAs","to move","{0} of {1} games imported");
